    ...
    def main(self, screen):
        ...
        while True:
            ...
            self.surf.blit(renderpair("Photo:",
                                      ...
                                      background=True,
                                      bgcolor=(
                                          (25, 155, 215, 108) if self.photo_info_rect.collidepoint(pg.mouse.get_pos())
        ...
        infos = list(map(lambda i: renderpair(i[0], i[1], font, 100, textcolor=i[2]),
                         [("Score", str(self.score), self.textcolor),
                          ("Health", str(self.health),
                           (255, 255 / self.max_health * self.health, 255 / self.max_health * self.health)),
...
if __name__ == '__main__':
    ...
    pg.display.set_caption("mohamed hany")
    Menu().main(screen)
